...
const ValidationIcon = ({
  ...
  if (!isSet) {
    return <UnsetIcon className="inline mr-1" />;
  }
  return hasError ? (
    <InvalidIcon className="inline mr-1" />
  ) : (
    <ValidIcon className="inline mr-1" />
  );
};
      ...
      >
        ...
        <div className="flex justify-center mb-4 mx-auto max-w-64">
          ...
          <button
            ...
            disabled={!formState.isValid || changePassword.loading}
          >
            Save
          </button>
        </div>
